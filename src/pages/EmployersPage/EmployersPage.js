    ...
    <>
      ...
      <div className="login-box2">
        ...
        <input
          ...
          />
           <button className="login-submit" type='submit'>Zapisz zmiany</button>
        </form>
      </div>
      ...
      <div className="logo-box">
        ...
        <form className="form-wrapper">
        <p>Format: <span className="light">PNG, JPG, mniejsze niż 4 MB</span></p>
           <button className="login-submit" type='submit'>Dodaj</button>
        </form>
      </div>
